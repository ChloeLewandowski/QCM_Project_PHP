...
<head>
  ...
  function creationTheme(){
    ...
    $html='<label for="formGroupExampleInput">Nouveau thème</label><input type="text" name="nomTheme" class="form-control" id="formGroupExampleInput" placeholder="titre thème">';
    document.getElementById('resultatradio').innerHTML=$html;
      ...
      <li class="nav-item active">
        ...
        <div id="content-wrapper">
          ...
          <div class="container-fluid">
            ...
            <form class="form" method="post" action="ajoutQCM.php">
              <div class="form-group">
                <label for="formGroupExampleInput">Titre</label>
                <input type="text" name="titreQCM" class="form-control" id="formGroupExampleInput" placeholder="titre QCM">
              </div>
